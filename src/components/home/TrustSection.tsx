...
export default function TrustSection() {
  return (
    <section id="trust" className="bg-[#F7FAFE] py-16 sm:py-26">
  ...
  {(() => {
    ...
    return (
      ...
      />
        ...
        <Reveal className="mt-8.5 flex items-center justify-center gap-25 rounded-2xl bg-ink px-15 py-12">
          <span className="shrink-0 text-[14px] font-bold tracking-[0.15em] whitespace-nowrap text-sky uppercase">
