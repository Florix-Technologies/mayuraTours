      ...
      <div className="flex flex-1 flex-col gap-2.5 px-6 pt-5.5 pb-6">
        ...
        <div className="mt-1 flex flex-wrap items-end justify-between gap-x-3 gap-y-3 border-t border-[#E9EFF7] pt-4">
          <div>
            ...
            {/* whitespace-nowrap: "On request" was breaking mid-phrase ("On" / "request")
                when squeezed against the button on narrow cards. Wrapping the whole row
                instead (flex-wrap above) drops the button to its own line cleanly. */}
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center gap-1.5 rounded-full bg-accent px-4.5 py-2.5 text-[12.5px] font-bold whitespace-nowrap text-white transition-[background-color,transform] duration-300 hover:-translate-y-0.5 hover:bg-navy"
          >
